                ...
                <header className="fixed top-0 w-full z-50 flex items-center justify-between border-b border-white/10 bg-background-dark/80 backdrop-blur-md px-6 lg:px-10 py-4">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="hidden md:flex flex-col items-end border-r border-white/10 pr-6 mr-2">
                            ...
                            <span className="text-yellow-400 font-mono text-[10px] uppercase">Professional</span>
                        </div>
                        ...
                        {activeTab === 'requests' && (
                            <div className="fade-in">
                                <div className="mb-10 border-b border-white/10 pb-6 flex justify-between items-end">
                                    <div>
                                        <h1 className="text-4xl md:text-5xl font-display font-bold uppercase tracking-tight mb-2">Signal Ingress</h1>
                                        <p className="font-mono text-sm text-gray-400">Incoming booking requests and active events.</p>
                                    </div>
                                    <div className="animate-pulse flex items-center gap-2 font-mono text-[10px] text-green-400 uppercase tracking-widest">
                                        <span className="block size-2 bg-green-400 rounded-full"></span> Live
                                    </div>
                                </div>
